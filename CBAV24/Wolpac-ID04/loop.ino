...
if (modelo == 1)  // se o bloqueio é modelo foca. garen ou wolpac
{
 ...
 cont0a:
  ...
  if (tipoEntr == 1)
    ...
    valor2 = analogRead(PIN_BTN6); // Lê o sensor 6 (entrada analogica) 
       ...
       if( valor1 > 3000 && valor2  > 3000) // verifica entradas analogicas
    {
      cont = 0;   // mantém ponto inicial
    }

      if( valor1 < 1000 && valor2  > 3000) // verifica entradas analogicas
    {
 ...
 if( valor1> 3000 && valor2  < 1000) // verifica entradas analogicas
    {
...
Serial.end();
  ...
  digitalWrite(pinoLedInterno, LOW);
    ...
    if(valor1 < 1000  &&   valor2 < 1000 )  // verifica se o estado do sensor 2 mudou e se mudou para LIGADO
    { 
      cont++;   // um quarto de giro para frente
      delay(25); // delay se mudou de estado
      goto cont2a ;
    ...
    if(valor1 > 3000 &&   valor2 > 3000 )  // verifica se o estado do sensor 1 mudou e se mudou para DESLIGADO
    { 
      cont--;     // um quarto de giro para trás
      delay(25); // delay se mudou de estado
      goto cont0a ;
    ...
    if(valor1 > 3000 &&   valor2 < 1000 )  // verifica se o estado do sensor 1 mudou e se mudou para DESLIGADO
    { 
...
cont2a: 
 ...
 if (tipoEntr == 1)
    ...
    valor2 = analogRead(PIN_BTN6); // Lê o sensor 6 (entrada analogica)  
      ...
      if(valor1 < 1000  &&   valor2 < 1000) // verifica entradas analogicas
    {
      cont = 2;   // mantém ponto inicial
    }
    if(valor1 > 3000  &&   valor2 < 1000 )  // verifica se o estado do sensor 2 mudou e se mudou para LIGADO
    { 
      cont++;   // um quarto de giro para frente
      delay(25); // delay se mudou de estado
      goto cont3a ;
    ...
    if(valor1 < 1000  &&   valor2 > 3000 )  // verifica se o estado do sensor 1 mudou e se mudou para DESLIGADO
    { 
      cont--;     // um quarto de giro para trás
      delay(25); // delay se mudou de estado
       goto cont1a ;
 ...
 if (tipoEntr == 1)
    ...
    if(valor1 > 3000  &&   valor2 > 3000 )  // verifica se o estado do sensor 2 mudou e se mudou para LIGADO
    { 
      cont++;   // um quarto de giro para frente
      delay(25); // delay se mudou de estado
      goto cont4a ;
    ...
    if(valor1 < 1000  &&   valor2 < 1000  )  // verifica se o estado do sensor 1 mudou e se mudou para DESLIGADO
    { 
      cont--;     // um quarto de giro para trás
      delay(25); // delay se mudou de estado
      goto cont2a ;
