...
#define FW_VERSION "5"
#define OTA_ASSET  "Foca_ID02.ino.bin"   // nome do binário desta variante dentro da release
...
int  numid = 2 ;  // id do dispositvo
int tipoEntr = 2 ; // 1 - divisor de tensão (garen,wolpac, 2 fios), 2 - Zener (Foca, switch, dois fios), Ascom/Monetel é indiferente a esta variavel
...
// valores historicos (nao recalibrado); Foca usa tipoEntr 2, entao nao valem para ele
...
const char *nomeota = "Foca-ID02"; // define nome que vai aparecer na IDE do arduino ao tentar programar via OTA  // "Monetel-ID01" "Foca-ID02" "Garen-ID03"  "Wolpac-ID04"
