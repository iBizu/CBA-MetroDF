...
int tipoEntr = 2 ; // 1 - divisor de tensão (garen, 2 fios), 2 - Zener (Foca, switch, dois fios), Ascom/Monetel é indiferente a esta variavel
...
const char *nomeota = "Foca-ID02"; // define nome que vai aparecer na IDE do arduino ao tentar programar via OTA  // "Monetel-ID01" "Foca-ID02" "Garen-ID03"
...
//conta o  movimento de giro da catraca: 4 é um giro compelto para frente, -4 é um giro completo para trás
...
//delay (500);
  ...
  //busca dados no SD para tualizar o display
